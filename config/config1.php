<?php	
	...
	if($_SERVER['HTTP_HOST'] == "localhost:8070")
	{
		echo "i am here";
		echo $dbCfg['host']			= "localhost:8070";
		$dbCfg['db_user']		= "administrator";
		$dbCfg['db_passwd']		= "SJ_Smec@egc_2012";
		$dbCfg['db_name']		= "demo_pmis";
	}
	var_dump($dbCfg);
		/*********** Define the values *********/
...
/**
  ...
  /**
	...
	/*echo $dbnmame="demo_pmis";
	echo $dbuser="root";
	echo $dbpassword="SJ_Smec@egc_2012";
	$con = new PDO("mysql:host=$host;dbname=$dbnmame;charset=UTF8",$dbuser,$dbpassword,array(PDO::ATTR_PERSISTENT=>true));
	if($con)
	{
		echo "successful";
	}
